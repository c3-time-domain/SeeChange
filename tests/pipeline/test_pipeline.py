...
def test_full_run_zogy( decam_exposure, decam_reference, decam_default_calibrators, user ):
    # This source at 1618.73, 1880.89 is a real SN
    expected = {
        'x':      np.array( [  784.65, 1452.32, 1438.79, 1450.94, 1618.73, 1357.84,  457.52, 1517.46 ] ),
        'y':      np.array( [  467.64,  806.58, 1462.75, 1626.67, 1880.89, 3493.17, 4007.80, 4043.11 ] ),
        'gfit_x':           [  784.68, 1450.95, 1437.51, 1450.43, 1618.72, 1357.67,  457.40, 1516.16 ],
        'gfit_y':           [  467.65,  808.81, 1464.30, 1626.50, 1880.79, 3491.58, 4006.31, 4041.07 ],
        'major_width': [ 2.53, 8.90, 8.12, 5.83, 4.04, 9.74, 7.89, 7.92 ],
        'minor_width': [ 2.02, 7.14, 7.68, 3.42, 3.14, 4.24, 6.31, 7.56 ],
        'neg_frac':      [ 0.25, 0.16, 0.07, 0.18, 0.07, 0.07, 0.23, 0.01 ],
        'neg_flux_frac': [ 0.04, 0.13, 0.06, 0.14, 0.04, 0.06, 0.20, 0.05 ],
        'psf_flux':      [  8898,  9487,  3063, 10153,  2265,   821,  2942, 22070 ],
        'psf_flux_err':  [   108,   166,   125,   162,    97,    87,   129,   254 ],
